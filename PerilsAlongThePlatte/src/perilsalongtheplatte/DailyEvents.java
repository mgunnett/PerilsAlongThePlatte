...
public class DailyEvents{
	//create an array to store the name of each weather event
	...
	/**
	 * A method that logs all events that happen to the player in a nice, convenient box in the application window. 
	 * This method calls other methods in this function to log results. 
	 */
